	...
	return (
		<div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
			<main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start w-full max-w-[720px]">
				<h1 className="text-6xl font-bold text-center w-full">CUINER IA</h1>

				<form
					onSubmit={handleSubmit}
					className="w-full flex gap-[20px] max-w-[500px] m-auto py-2 px-4 border-2 border-white rounded-3xl box dark:bg-[#0a0a0a]"
				>
					<input
						type="text"
				...
				<div className="w-full grid gap-6">
					{error !== null
						...
						: recipes.map((recipe, index) => (
								<div
									key={index}
									className="bg-[#1f1f1f] shadow-zinc-800 p-4 rounded-md shadow-md mb-4"
								>
